...
export const BUILD_URL = new URL(
  app.commandLine.hasSwitch("force-server")
    ...
    : /*MAIN_WINDOW_VITE_DEV_SERVER_URL ??*/ "https://gangio.pro",
);
...
export function createMainWindow(options?: { show?: boolean }) {
  ...
  ipcMain.handle("get-desktop-sources", async (_, options: { types?: string[]; thumbnailSize?: { width: number; height: number }; fetchWindowIcons?: boolean }) => {
